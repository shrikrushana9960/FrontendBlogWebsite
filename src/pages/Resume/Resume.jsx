...
const Resume = () => {
    const imgurl =
      "https://1.bp.blogspot.com/-DzNXSuUCk5U/YE-wq2Iyw3I/AAAAAAAAEos/yx-gKtItYuwNX3S6s9dy5F1yxiREtCM6wCLcBGAsYHQ/s2048/IMG_20210312_163142_1.jpg";
    return (
        <div>
    ...
    <div class="card-container">
        <div class="name-container">
            ...
            <h2>Shrikrushna Pingale</h2>
            <p>Front end devloper</p>
        </div>
        <div class="section about-section">
            <h4 class="section-title">About</h4>
            <div class="body-text">
                <p>Front end devleoper, Develop react web application. .</p>
            </div>
        </div>
